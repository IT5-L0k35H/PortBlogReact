...
INSERT INTO
    users (role_id, email, first_name, last_name)
VALUES
    (1, 'lvlokesh2102@gmail.com', 'Lokesh', 'Verma');

INSERT INTO
    blog_categories (label, description)
VALUES
    (
        'JavaScript',
...
Tell me about your stories in the comments!\n"}]}',
    ...
    (
        1,
        'Using AWS S3 for storing blog images',
        'Lorem ipsum dolor sit amet, consectetur adipisicing elit.',
        '',
    ...
    (
        ...
        'Lorem ipsum dolor sit amet, consectetur adipisicing elit.',
        '',
        'https://images.pexels.com/photos/34140/pexels-photo.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
        1,
        'Functional Programming',
        'ES6',
        'https://images.pexels.com/photos/34140/pexels-photo.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
    ...
    (
        1,
        'Brain Hacks for Learning to Program',
        'Lorem ipsum dolor sit amet, consectetur adipisicing elit.',
        '',
        'https://images.pexels.com/photos/2777898/pexels-photo-2777898.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
        1,
        'Functional Programming',
        'ES6',
        'https://images.pexels.com/photos/2777898/pexels-photo-2777898.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
    ...
    (
        1,
        'Software Engineer Salary in 2020',
        'Lorem ipsum dolor sit amet, consectetur adipisicing elit.',
        '',
        'https://images.pexels.com/photos/4475524/pexels-photo-4475524.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
        1,
        'Functional Programming',
        'ES6',
        'https://images.pexels.com/photos/4475524/pexels-photo-4475524.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
    ...
    (
        ...
        'Lorem ipsum dolor sit amet, consectetur adipisicing elit.',
        '',
        'https://images.unsplash.com/photo-1593376893114-1aed528d80cf?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=658&q=80',
        1,
        'Functional Programming',
        'ES6',
        'https://images.unsplash.com/photo-1593376893114-1aed528d80cf?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=658&q=80',
    ...
    (
        ...
        'Lorem ipsum dolor sit amet, consectetur adipisicing elit.',
        '',
        'https://images.unsplash.com/photo-1472437774355-71ab6752b434?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=967&q=80',
        1,
        'Functional Programming',
        'ES6',
        'https://images.unsplash.com/photo-1472437774355-71ab6752b434?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=967&q=80',
...
INSERT INTO
    blog_post_comments (post_id, author_id, comment)
VALUES
    (1, 1, 'Totally broooo!'),
    (1, 1, 'Friggin owrsome');
